...
export default function HomeScreen({
  ...
  onNavigate: (screen: 'progress' | 'meditation' | 'social' | 'avatar' | 'plan' | 'mobility') => void;
  onLogout: () => void;
}) {
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <View style={styles.footerLinks}>
        ...
        <Pressable onPress={() => onNavigate('mobility')}><Text style={styles.link}>Mobility Test</Text></Pressable>
